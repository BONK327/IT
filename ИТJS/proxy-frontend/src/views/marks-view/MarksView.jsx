...
import { MarksDialog } from "../../components/dialogs/marks-dialog/MarksDialog";
...
export const MarksView = ({
    ...
    useEffect(() => {
      const fetchData = async () => {
          const list = await MarksService.getAllRecords();
          setList(list);
      };
    ...
    const deleteRecordHandler = async (recordId) => {
        await MarksService.removeRecord(recordId);
