...
import { DocBodiesCreateDialog } from "../../../components/dialogs/doc-bodies-dialog/DocBodiesCreateDialog"; 
...
const [clas, setClas] = useState([]);
 ...
 const saveBody = async (id) => { 
   list.forEach( async (record) => {
    record['docHeaderId'] = id; 
    delete record.id; 
    await DocBodyService.createRecord(record); 
   }); 
 } 
 ...
 const saveRecordHandler = async () => { 
   await saveHeader(); 
   const allRecords = await DocHeadersService.getAllRecords(); 
